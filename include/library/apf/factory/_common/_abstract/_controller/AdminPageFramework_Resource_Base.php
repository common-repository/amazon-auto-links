...
abstract class AmazonAutoLinks_AdminPageFramework_Resource_Base extends AmazonAutoLinks_AdminPageFramework_FrameworkUtility {
    ...
    public function _replyToEnqueueCommonStyles()
    {
        ...
        $this->_addEnqueuingResourceByType(AmazonAutoLinks_AdminPageFramework_Registry::$sDirPath . '/factory/_common/asset/css/common.css', array( 'version' => AmazonAutoLinks_AdminPageFramework_Registry::VERSION, ), 'style');
    }
