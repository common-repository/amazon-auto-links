...
class AmazonAutoLinks_AdminPageFramework_Form_Model___SetFieldResources extends AmazonAutoLinks_AdminPageFramework_Form_Base {
    ...
    private function ___setCommonFormJavaScriptScripts()
    {
        ...
        $this->aResources[ 'src_scripts' ][] = array( 'handle_id' => 'amazon-auto-links-script-form-main', 'src' => AmazonAutoLinks_AdminPageFramework_Registry::$sDirPath . '/factory/_common/form/asset/js/form.bundle.js', 'dependencies' => array( 'jquery', 'wp-pointer', 'jquery-ui-sortable' ), 'in_footer' => true, 'version' => AmazonAutoLinks_AdminPageFramework_Registry::VERSION, 'translation' => $_aData, 'translation_var' => 'AmazonAutoLinks_AdminPageFrameworkScriptFormMain', );
        $this->aResources[ 'register' ][ 'scripts' ][] = array( 'handle_id' => 'amazon-auto-links-script-form-collapsible-sections', 'src' => AmazonAutoLinks_AdminPageFramework_Registry::$sDirPath . '/factory/_common/form/asset/js/form-collapsible-sections.js', 'dependencies' => array( 'jquery', 'jquery-ui-accordion', 'amazon-auto-links-script-form-main' ), 'in_footer' => true, 'version' => AmazonAutoLinks_AdminPageFramework_Registry::VERSION, );
        if (function_exists('wp_enqueue_media')) {
            $this->aResources[ 'register' ][ 'scripts' ][] = array( 'handle_id' => 'amazon-auto-links-script-form-media-uploader', 'src' => AmazonAutoLinks_AdminPageFramework_Registry::$sDirPath . '/factory/_common/form/asset/js/form-media-uploader.js', 'dependencies' => array( 'jquery', 'amazon-auto-links-script-form-main' ), 'in_footer' => false, 'version' => AmazonAutoLinks_AdminPageFramework_Registry::VERSION, 'translation_var' => 'AmazonAutoLinks_AdminPageFrameworkScriptFormMediaUploader', 'translation' => array( 'messages' => array( 'returnToLibrary' => $this->oMsg->get('return_to_library'), 'select' => $this->oMsg->get('select'), 'insert' => $this->oMsg->get('insert'), ), ), );
        }
    }
    private function ___setCommonFormExternalStylesheets()
    {
        $this->aResources[ 'src_styles' ][] = array( 'handle_id' => 'amazon-auto-links-form', 'src' => AmazonAutoLinks_AdminPageFramework_Registry::$sDirPath . '/factory/_common/form/asset/css/form/form.css', );
        $this->aResources[ 'src_styles' ][] = array( 'handle_id' => 'amazon-auto-links-form-ie', 'src' => AmazonAutoLinks_AdminPageFramework_Registry::$sDirPath . '/factory/_common/form/asset/css/form_ie/form_ie.css', 'conditional' => 'IE', );
        $this->aResources[ 'src_styles' ][] = array( 'handle_id' => 'wp-pointer', );
        if (version_compare($GLOBALS[ 'wp_version' ], '5.3', '>=')) {
            $this->aResources[ 'src_styles' ][] = array( 'handle_id' => 'amazon-auto-links-form-5_3-or-above', 'src' => AmazonAutoLinks_AdminPageFramework_Registry::$sDirPath . '/factory/_common/form/asset/css/form_5_3_or_above/form_5_3_or_above.css', );
        }
        if (version_compare($GLOBALS[ 'wp_version' ], '4.7', '>=')) {
            $this->aResources[ 'src_styles' ][] = array( 'handle_id' => 'amazon-auto-links-form-4_7-or-above', 'src' => AmazonAutoLinks_AdminPageFramework_Registry::$sDirPath . '/factory/_common/form/asset/css/form_4_7_or_above/form_4_7_or_above.css', );
        }
        if (version_compare($GLOBALS[ 'wp_version' ], '3.8', '<')) {
            $this->aResources[ 'src_styles' ][] = array( 'handle_id' => 'amazon-auto-links-form-4_8-below', 'src' => AmazonAutoLinks_AdminPageFramework_Registry::$sDirPath . '/factory/_common/form/asset/css/form_3_8_below/form_3_8_below.css', );
        }
        if (version_compare($GLOBALS[ 'wp_version' ], '3.8', '>=')) {
            $this->aResources[ 'src_styles' ][] = array( 'handle_id' => 'amazon-auto-links-form-3_8-or-above', 'src' => AmazonAutoLinks_AdminPageFramework_Registry::$sDirPath . '/factory/_common/form/asset/css/form_3_8_or_above/form_3_8_or_above.css', );
        }
    }
