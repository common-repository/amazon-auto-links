...
class AmazonAutoLinks_AdminPageFramework_FieldType_import extends AmazonAutoLinks_AdminPageFramework_FieldType_submit {
    ...
    {
        return array( array( 'handle_id' => 'amazon-auto-links-field-type-import', 'src' => dirname(__FILE__) . '/js/import.bundle.js', 'in_footer' => true, 'dependencies' => array( 'jquery', 'amazon-auto-links-script-form-main' ), 'translation_var' => 'AmazonAutoLinks_AdminPageFrameworkImportFieldType', 'translation' => array( 'fieldTypeSlugs' => $this->aFieldTypeSlugs, 'label' => array( 'noFile' => $this->oMsg->get('import_no_file'), ), ), ), );
    }
