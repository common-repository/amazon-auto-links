...
class AmazonAutoLinks_AdminPageFramework_FieldType_taxonomy extends AmazonAutoLinks_AdminPageFramework_FieldType_checkbox {
    ...
    {
        return array( array( 'handle_id' => 'amazon-auto-links-field-type-taxonomy', 'src' => dirname(__FILE__) . '/js/taxonomy.bundle.js', 'in_footer' => true, 'dependencies' => array( 'jquery', 'amazon-auto-links-script-form-main' ), 'translation_var' => 'AmazonAutoLinks_AdminPageFrameworkFieldTypeTaxonomy', 'translation' => array( 'fieldTypeSlugs' => $this->aFieldTypeSlugs, 'label' => array(), ), ), );
    }
