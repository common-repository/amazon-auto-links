...
class AmazonAutoLinks_AdminPageFramework_Model__FormSubmission__Validator__Export extends AmazonAutoLinks_AdminPageFramework_Model__FormSubmission__Validator__Import {
    ...
    {
        $_oExport = new AmazonAutoLinks_AdminPageFramework_ExportOptions($this->getHTTPRequestSanitized($this->getElementAsArray($_POST, array( '__export' ))), $this->oFactory->oProp->sClassName);
