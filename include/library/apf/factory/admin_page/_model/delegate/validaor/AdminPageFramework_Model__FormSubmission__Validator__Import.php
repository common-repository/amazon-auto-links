...
class AmazonAutoLinks_AdminPageFramework_Model__FormSubmission__Validator__Import extends AmazonAutoLinks_AdminPageFramework_Model__FormSubmission__Validator_Base {
    ...
    {
        $_oImport = new AmazonAutoLinks_AdminPageFramework_ImportOptions($this->getHTTPRequestSanitized($_FILES[ '__import' ], false), $this->getHTTPRequestSanitized($_POST[ '__import' ]));
