...
class AmazonAutoLinks_AdminPageFramework_FormEmail extends AmazonAutoLinks_AdminPageFramework_FrameworkUtility {
    ...
    public function send()
    {
        ...
        do_action('amazon-auto-links_action_before_sending_form_email', $_aEmailOptions, $_aInputs, $_sSubmitSectionID);
        ...
        do_action('amazon-auto-links_action_after_sending_form_email', $_bSent, $_aEmailOptions);
